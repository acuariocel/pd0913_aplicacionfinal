...
public class Menu extends javax.swing.JDialog {
     ...
     * @param eqp
     */
    public Menu(MenuEstudiante menuEstudiante, Usuarios u, Equipos eqp) {
        this.u = u;
        ...
        if (res1.equals("false")) {
            dispose();
            JOptionPane.showMessageDialog(this, "No se pudo registrar la sesión de usuario, informe al administrador del sistema");
            ...
            if (!res.equals("true")) {
                JOptionPane.showMessageDialog(null, "Error al cambiar estado de equipo, contacte con el administrador");
                dispose();
                new Login(0).setVisible(true);
            }
            try {
